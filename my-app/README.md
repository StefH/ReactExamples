...
``` sh
npx create-react-app my-app2 --scripts-version=react-scripts-ts
```

## Prerequisites

- node.js version 10 or 11 installed [download](https://nodejs.org/en/)
- yarn globally installed (`npm i yarn -g`)
- eslint, tslint and typescript globally installed (`npm i typescript eslint tslint -g`)
...
You need to **put any TS/TSX and CSS files inside `src`**, otherwise Webpack won’t see them.
